...
// VET Register
    ...
    echo "Ce mail est déjà utilisé <br> Retour accueil <br> <a href='../views/home.php' id='home_link'>
    ...
    echo " Merci pour votre inscription <br> Retour accueil <br> <a href='../views/home.php' id='home_link'>
    <img src='../style/image/logo-vetoclock.png' alt='Vetoclock image' id='vetoclock' width='100'> 
  </a>";